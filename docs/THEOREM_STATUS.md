...
- **Dimension independence:** the same local assumptions do not select `n=3`.
...
- **Open:** native composition law, native dimension selection, same-input new physical prediction, gravity/capacity law.
